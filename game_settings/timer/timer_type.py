...
class TimerType:
    ...
    def __init__(self, parent):
        ...
        self.timer_type_title = tk.Label(
            self.parent.root,
            text= "Timer Type",
            font= ("TF2 Build", 15),
            bg= "gray20",
        ...
        self.timer_type_chronometer = tk.Radiobutton(
            self.parent.root,
            text="Chronometer",
            font=("Arial", 10, "bold"),
            bg="gray20",
        ...
        self.timer_type_timer = tk.Radiobutton(
            self.parent.root,
            text="Timer",
            font=("Arial", 10, "bold"),
            bg="gray20",
    ...
    def check_timer_type_menu(self) -> None:
        ...
        if self.parent.parent.prp.timer_style == "timer":
            self.parent.parent.prp.timer_custom_time = 0

        menu_items: list[tk.Widget] = [
            self.timer_type_title,
